...
THE FOLLOWING TEXT COMBINES CODES AND THEIR EXPLANATIONS.
...
By adding using namespace std;, you can use C++ library functions without prefixing them with std::. For example, cout 
